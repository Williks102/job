...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI job recommendation system. Given the following job seeker profile, recommend a list of relevant job offers.
...
Ensure that each job offer includes the job title, company, location, description, skills required and salary.
`,  
});
